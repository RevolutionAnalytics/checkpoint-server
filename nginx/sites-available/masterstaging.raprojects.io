...
server {
        ...
        root /home/devstaging-user/jenkins/workspace/raprojects-masterbranch/dist;
        index index.html index.htm;

        # public facing domain name for this vhost
        server_name masterstaging.raprojects.io master-staging.raprojects.io;
